...
1. Clone the repo.
2. Change to the project directory and get submodules.
	```
	$ cd wowpkg
...
6. Create a build directory and compile.
	...
	$ cmake --build .
	```
7. Change the path in [config.ini](dev_only/config.ini) to where you want the addons to be extracted. Something like `/path/to/wowpkg/dev_only/addons`.
