 ...
 * is all text to the right of the '='. Names and values may be empty, in such
 * a case they would be parsed as the empty string.
 *
 * Case sensitivity
 * ----------------
 * The current design makes no distinction between case sensitivity. Sections,
 * names, and values are passed to the caller without modification. It is up to
